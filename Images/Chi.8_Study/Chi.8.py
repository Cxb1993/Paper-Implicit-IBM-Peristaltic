...
StressStr = r'${\displaystyle %s}$' % stress
LogStressStr = r'${\displaystyle \log %s}$' % stress
StressFont = 18
print StressStr
print LogStressStr
...
m.xlabel(r'$t$', fontsize=StressFont)
m.ylabel(StressStr, fontsize=StressFont)
m.legend(loc=2)
...
print "slope =", slope
m.xlabel(r'$\log N$', fontsize=StressFont)
m.ylabel(StressStr, fontsize=StressFont)
...
#m.xlabel(r'$\log N$')
#m.ylabel(LogStressStr, fontsize=StressFont)
#m.savefig('Chi.8_T1.25_log.png')
